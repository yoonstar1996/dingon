...
`;
  ...
  const [comment, setComment] = useState([{ name: "병신을보면 짖는개", comment: "wdewedwewef" }, { name: "재매이햄", comment: "wefwefwfewfe" }])
        ...
        <div className="content">
          <div className="headBar">
            ...
            <div className="fixButton">
              {isLogin === userId ? <Link style={{ textDecoration: 'none' }} to={"/gallery/made/" + id}>
                <Button style={{ background: "#4545AC" }} variant="contained">수정</Button>
              </Link> : <></>}
            </div>
          </div>
          <div className="headInfo">
            <div className="contentTitle">
              <div>
                <h4 style={{ marginTop: 0, marginBottom: "10px" }}>{cont.title}</h4>
              </div>
              <div>
